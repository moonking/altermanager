...
export function getMaintenanceList (params) {
  return request({
    url: baserUrl + 'alert/ops_for_source/list',
    method: 'post',
    data: params
  })
}
...
export function editMaintenance (params) {
  return request({
    url: baserUrl + 'alert/ops_for_source/updateStatus',
    method: 'put',
    type: 'change',
    data: qs.stringify(params)
  })
...
export function addMaintenance (params) {
  return request({
    url: baserUrl + 'alert/ops_for_source/add',
    method: 'POST',
    data: params
  })
}
...
export function updateMaintenance (params) {
  return request({
    url: baserUrl + 'alert/ops_for_source/update',
    method: 'POST',
    data: params
  })
}
...
export function deleteMaintenance (id) {
  return request({
    url: baserUrl + 'alert/ops_for_source/delete/' + id,
    method: 'DELETE'
  })
}
// 获取维护窗口详情
export function getMaintenanceDetail (id) {
  return request({
    url: baserUrl + 'alert/ops_for_source/details/' + id,
    method: 'get'
  })
}
...
export function getAlarmInform () {
  return request({
    url: baserUrl + 'api/alarmInform/statistics' ,
    method: 'GET'
  })
}
...
export function readAll () {
  return request({
    url: baserUrl + 'api/alarmInform/receive' ,
    method: 'PUT'
  })
}
...
export function getLoginlog (params) {
  return request({
    url: baserUrl + 'api/loginlog/list' ,
    method: 'POST',
    data: params
  })
}
...
export function getSumData (id) {
  return request({
    url: baserUrl + 'alert/statistics/' + id,
    method: 'GET'
  })
}

// 获取告警数据统计之级别
export function getleveSumData (id) {
  return request({
    url: baserUrl + 'alert/statistics/level/' + id,
    method: 'GET'
  })
}
...
// 批量导入系统列表
export function addsystemForBatch (params) {
  return request({
    url: baserUrl + 'alert/config/batch' ,
    method: 'POST',
    data: params
  })
}
...
// 批量更新系统中的特殊配置
export function updatesystemForBatch (params) {
  return request({
    url: baserUrl + 'alert/config/update/batch' ,
    method: 'POST',
    data: params
  })
}
...
//获取单个system配置
export function getSystemOne (id) {
  return request({
    url: baserUrl + 'alert/config/' + id,
    method: 'GET'
  })
...
// 新增单个system
export function addSystemOne (params) {
  return request({
    url: baserUrl + 'alert/config/save',
    method: 'POST',
    data: params
  })
}
...
//配置7*24和5*8
export function  configSystemLevel (params) {
  return request({
    url: baserUrl + 'alert/silence/save' ,
    method: 'POST',
    data: params
  })
}
//获取7*24 和5*8 的配置
export function getSystemLevel (id) {
  return request({
    url: baserUrl + 'alert/silence/' + id,
    method: 'GET'
  })
}

//system特殊配置开启
export function  systemStatusSwitch (id, boolen) {
  return request({
    url: baserUrl + 'alert/config/' + id  + '/' + boolen,
    method: 'POST',
  })
}
