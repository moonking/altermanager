    ...
    return {
      ...
      AIA: [
        ...
        // },
        {
          ...
          subs: [
            {
              index: '/Aibms/otherConfiguration/infoAlter?code=2',
              title: '待分类告警'
            },
            {
            ...
            {
              index: '/Aibms/otherConfiguration/systemOperation?code=2',
              title: '业务系统配置'
            },
            {
          ...
          subs: [
            {
              ...
              index: 'https://10.130.116.100:8000/zh-CN/app/itsi/saved_homepage_lister',
              title: 'Splunk'
            },
            {
              url: '/Aibms?code=2&type=BPC',
              index: 'https://10.130.116.224:8443/bpc',
              title: 'BPC'
            },
            {
              url: '/Aibms?code=2&type=NPM',
              index: 'https://10.130.116.224:8443/zh-hans/accounts/login',
              title: 'NPM'
            },
            {
        ...
        },
        {
          ...
          subs: [
            {
              index: '/Aibms/Infoself/selfcheck?code=2',
              title: '服务自检'
            },
            {
              index: '/Aibms/Infoself/loginlog?code=2',
              title: '平台登陆日志'
            },
            {
              index: '/Aibms/Infoself/statistics?code=2',
              title: '告警统计'
            }
          ]
        }
