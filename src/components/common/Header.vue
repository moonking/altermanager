    ...
    <div class="header-right">
      <div class="header-user-con">
        ...
        <!-- <div class="btn-bell">
          <el-tooltip
            effect="dark"
            :content="alternum?`有${alternum}条未读告警`:`告警通知`"
            placement="bottom"

          >
            <router-link to="/Aibms/alarmnotice?code=2">
              <i class="el-icon-bell" />
            </router-link>
          </el-tooltip>
          <span class="btn-bell-badge" v-if="alternum"></span>
        </div>
 -->
...
export default {
  ...
  methods: {
    ...
    // 跳转去告警通知页面
    routeToDetail() {
      if (this.$route.path == '/Aibms/alarmnotice') {
        location.reload()
      } else {
        this.$router.push({
