      ...
      <div class="operate-bar">
        <el-form inline :model="search" class="demo-form-inline">
          ...
          <el-form-item class="item-right overHideMargin">
            <el-button icon="el-icon-search" class="nomal-button" @click="searchTask">查找</el-button>
            <el-button
              type="primary"
              icon="el-icon-plus"
          ...
          <el-table-column label="操作" align="center" prop="operate" width="200px">
            <template slot-scope="scope">
              <div class="task-btn-box">
                ...
                <span
                  class="special"
                  @click="editJob(scope.row.manageId, scope.row.taskType,scope.row.applyStatus)"
                >
                ...
                <span
                  ...
                  @click=" scope.row.conflict !== 'building' && deleteJob(scope.row.manageId,scope.row.applyStatus,scope.row.taskType)"
                >
...
export default {
  ...
  methods: {
    ...
    confirmDelete () {
      axios.cancleCronTab(this.cancleId).then(res => {
        if (res.data.code === 200) {
          this.getReleaseList()
    ...
    addTask () {
      this.$router.push({
        ...
        path: '/AutomatedRelease/CronPage/create'
      })
    },
    readJob (id) {
      this.$router.push({
        ...
        path: '/AutomatedRelease/CronPage/read'
      })
    },
    editJob (id) {
      this.$router.push({
        ...
        path: '/AutomatedRelease/CronPage/edit'
      })
    },
