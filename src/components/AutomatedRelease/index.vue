    ...
    <el-row :gutter="24">
      <el-col :span="11">
        <div class="workbench-box">
          <div class="workbench-box_item aibms-color-bg">
            <div class="workbench-box_title white-color">
              待发布任务
              <el-button
                class="search-more nomal-button"
                size="mini"
                icon="el-icon-search"
                @click="gotoRelease"
              >查看更多</el-button>
      ...
      <el-col :span="13">
        <div class="workbench-box">
          <div class="workbench-box_item aibms-color-bg">
            ...
            <div class="workbench-box_tchart white-color">
              发布成功率统计
              <el-select
                class="workbench-select"
                size="mini"
