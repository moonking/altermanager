  ...
  <div class="task-list aibms-role">
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="name" label="项目组编号"></el-table-column>
        <el-table-column prop="name" label="制品编号"></el-table-column>
        ...
        <el-table-column prop="address" align="center" label="操作" width="330px">
          <template>
      ...
      <el-dialog center title="同步配置" :visible.sync="dialogVisible" width="30%">
        <el-form
      ...
      <el-dialog center :visible.sync="dialogVisibleDelete" title="提示" width="300px">
        <div :style="{textAlign: 'center'}">
          <i class="el-icon-warning"></i>&nbsp;&nbsp;确定要删除该配置包吗？
        </div>
...
export default {
  ...
  methods: {
    ...
    goWarehouse (key) {
      this.$router.push({
        path: '/AutomatedRelease/ConfigurationPackage/' + key,
        query: {
          code: 3
        }
      })
