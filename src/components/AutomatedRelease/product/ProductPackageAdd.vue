<template>
  <div class="container refreshContainer aibms-color-bg non-border non-shadow white-color">
    ...
    >
      <el-form-item class="productPackage-item" label="所属业务系统：" prop="name">
        <el-input
      ...
      <el-form-item class="productPackage-item" label="所属仓库" prop="markName">
        <el-input
          :disabled="status === 'read'"
          maxlength="20"
          v-model="productPackage.markName"
          placeholder="请输入所属仓库"
          style="min-width: 632px"
        ></el-input>
      </el-form-item>
      <el-form-item class="productPackage-item" label="项目组编号：" prop="environmental">
        <el-input
          :disabled="status === 'read'"
          maxlength="20"
          v-model="productPackage.markName"
      ...
      <el-form-item class="productPackage-item" label="制品编号：" prop="warehouseType">
        <el-input
          :disabled="status === 'read'"
          maxlength="20"
          v-model="productPackage.markName"
      ...
      <el-form-item class="productPackage-item" label="版本号：" prop="saveType">
        <el-input
          :disabled="status === 'read'"
          maxlength="20"
          v-model="productPackage.markName"
...
.productPackage-item input,
.productPackage-item select {
  width: 100%;
}
