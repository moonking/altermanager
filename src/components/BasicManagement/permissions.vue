    ...
    <div class="customBox">
      <el-row>
        ...
        <div class="item-right">
          <router-link
            :to="{ path:'/BasicManagement/permissions/addSystem?code=1',query: {id:systemId}}"
          >
            <el-button type="primary" icon="el-icon-plus" class="common-btn-style">新增</el-button>
          </router-link>
          <router-link
            :to="{ path:'/BasicManagement/permissions/editSystem?code=1',query: {id:systemId}}"
          >
            <el-button type="primary" class="common-btn-style margin-left-btn">
              <span class="iconfont icon-bianji" style="margin-right: 10px;"></span>修改
            </el-button>
          </router-link>
    ...
    >
      <div class="headportraitbox">
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          <div class>
            <el-form-item label="系统名称：" prop="name" class="disinlne" style="width:94%">
              <el-input
                v-model="form.name"
                autocomplete="off"
                maxlength="10"
          ...
          <div>
            <el-form-item label="系统标识：" prop="permission" class="disinlne" style="width:94%">
              <el-input
          ...
          <div>
            <el-form-item label="系统地址：" prop="href" class="disinlne" style="width:94%">
              <el-input
                v-model="form.href"
                autocomplete="off"
                maxlength="30"
          ...
          <div class="dai-save-btn">
            <el-button
              ...
              @click="addsysteam()"
            >保存</el-button>
            <el-button class="nomal-button" @click="addSystemBox = false">取消</el-button>
          </div>
        </el-form>
      </div>
    </el-dialog>
