<template>
  <div class="panel">
    <div class="panel-main">
      <div class="workbench">
        <div class="panel-title">
          ...
          <div>
            <img
              @click="goOperationWorkOrder"
              class="get-more"
              src="../../../../static/img/get_more.png"
              alt="更多"
            />
          </div>
        </div>
        <div class="icon_box">
          <el-button-group>
            <el-button @click="changeWorkRange(1)">今日</el-button>
            <el-button @click="changeWorkRange(7)">本周</el-button>
            <el-button @click="changeWorkRange(30)">本月</el-button>
          </el-button-group>
        </div>
        <el-table
          :data="warehouseList"
                ...
                <el-dropdown>
                  <el-tooltip class="edit" effect="dark" content="更多" placement="top-start">
                    <span class="el-dropdown-link drop_down">
                      <img class="icon_more" src="../../../../static/img/more.png" alt />
                    </span>
                  </el-tooltip>
    ...
    <div class="panel-bar">
      <div class="bar-item">
        <div class="panel-title special">
          <div>
            <span>资源统计</span>
          </div>
          <div>
            <img
              @click="goResourceManage"
              class="get-more"
              src="../../../../static/img/get_more.png"
              alt="更多"
            />
      ...
      <div class="bar-item">
        ...
        <ul class="panel-items">
          <li>
            <span>
              <img src="../../../../static/img/icon_pass.png" alt />
            </span>
            <span>{{ healthyResult.successCount }}个</span>
          </li>
          <li>
            <span>
              <img src="../../../../static/img/icon_unpass.png" alt />
            </span>
      ...
      <div class="bar-item">
        ...
        <ul class="panel-items">
          <li v-for="(item,index) in works" :key="index">
            ...
            <span class="icon">
              <el-progress type="circle" :width="60" :percentage="item.sucessRate" />
            </span>
          </li>
        </ul>
      </div>
...
.panel-items li span:nth-child(1) {
  padding-top: 10px;
}
.panel-items li .icon {
  padding-top: 10px;
