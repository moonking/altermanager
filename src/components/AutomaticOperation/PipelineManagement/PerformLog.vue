<template>
  <div class="node-layout">
    <el-row :gutter="10">
      <el-col :span="4">
        <el-input v-model="nodename" placeholder="请输入流水线名称" clearable />
      </el-col>
      <el-col :span="4">
      ...
      <el-col :span="4" class="search-wrapper">
    ...
    <el-row :gutter="20" style="padding:30px 10px;">
      ...
      >
        ...
        <el-table-column prop="environmentName" label="执行环境" />
        <el-table-column prop="source" label="来源" />
        <el-table-column prop="pipeStartTime" label="开始时间" />
        <el-table-column prop="timeConsum" label="共执行时间" />
...
export default {
  ...
  methods: {
    ...
    // 查看详情
    editNode (row) {
      let type = row.remarks === '3' ? 'pipelineLogId' : 'templateLogId'
      this.$router.push({
