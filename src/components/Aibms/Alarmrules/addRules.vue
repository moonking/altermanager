<template>
  <div class="aia-content">
    <div class="wrapper_pannel">
          ...
          <el-row v-else :gutter="20">
            ...
            <el-col :span="20">
              <el-checkbox-group v-model="typesForm.type" @change="handlecheckedClassChange">
                <el-checkbox
                  :disabled="status==='read' || item.level != ''"
        ...
        <el-form-item v-if="noticeInform.length>0">
          ...
          >
            ...
            <el-table-column
              ...
              width="220"
            ></el-table-column>
            <el-table-column align="center" prop="department" label="部门-职位" show-overflow-tooltip></el-table-column>
      ...
      <div class="op-btns">
        <el-button type="primary" v-if="active===1" @click="isActive(0)">上一步</el-button>
        <el-button type="primary" v-if="active!==1" @click="isActive(1)">下一步</el-button>
        <el-button type="primary" v-if="active===1&&status!=='read'" @click="saveAlarm">保存</el-button>
      ...
      >
        ...
        >
          ...
          <el-form-item v-if="tipsForm.mode===1" label="人员及通知方式："></el-form-item>
          <el-tabs v-if="tipsForm.mode===1" v-model="activeName" @tab-click="handleClick">
            <el-tab-pane
            ...
            >
              ...
              >
                ...
                <el-table-column align="center" label="通知方式" width="165">
                  <template slot-scope="scope">
                    <el-checkbox-group v-model="scope.row.checkList" @change="checkSmsEmail(scope)">
                      <el-checkbox :disabled="status==='read'" label="email">邮件</el-checkbox>
                      <el-checkbox :disabled="status==='read'" label="message">短信</el-checkbox>
                    </el-checkbox-group>
                  </template>
                </el-table-column>
              </el-table>
        ...
        <div class="op-btns">
          ...
          <el-button @click="handleDialogClose" class="cancel-button">取消</el-button>
        </div>
      </el-dialog>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    hiddenCheck() {
      ...
      if (this.status === "read") { 
        if (document.getElementsByClassName("el-table-column--selection").length > 0) {
    ...
    classCheckStatus(type) {
      let bl = true;
      let num = 0;
      let codeList = (this.classList.filter(item => item.level === '')).map(item => item.code)
